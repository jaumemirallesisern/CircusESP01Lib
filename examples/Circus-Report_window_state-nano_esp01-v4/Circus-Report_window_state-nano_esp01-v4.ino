/*
  Circus-Report_window_state-nano_esp01-v4.ino
  
  This example code that shows how to read a signal using the circusofthings.com API through its CircusESP01Lib-4.0.0 library for Arduino.
  
  This code will read a set point at Circus and set it to a fan.
  ...
  Created by Jaume Miralles Isern, June 25, 2019.
*/
...
CircusESP01Lib circusESP01(&ss,esp01BaudRate,server,token,ssid,password,debugLevel);
